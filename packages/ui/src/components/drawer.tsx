...
export const DrawerBody: typeof DrawerContent = DrawerContent;
export const DrawerBackdrop: typeof DrawerOverlay = DrawerOverlay;
export const DrawerCloseTrigger: typeof DrawerClose = DrawerClose;
export const DrawerActionTrigger: typeof DrawerClose = DrawerClose;
