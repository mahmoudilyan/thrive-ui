...
/**
 * Settings Duotone Icon - Material Icons Two Tone style
 * @see https://fonts.google.com/icons?selected=Material+Icons+Two+Tone:settings
 */
export default function SettingsDuotoneIcon(props: IconProps) {
	...
	return (
		<svg
			...
			{...rest}
		>
			{/* Secondary fill with opacity - inner gear circle */}
			<path
				opacity=".3"
