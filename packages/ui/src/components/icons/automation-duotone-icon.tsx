...
/**
 * Automation/Autorenew Duotone Icon - Material Icons Two Tone style
 * @see https://fonts.google.com/icons?selected=Material+Icons+Two+Tone:autorenew
 */
export default function AutomationDuotoneIcon(props: IconProps) {
