...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/tabs.unstyled';
...
export function CodeBlock({
	...
	return (
		<figure
			...
			{...props}
			className={cn(
				inTab ? 'bg-panel -mx-px -mb-px last:rounded-b-xl' : 'my-4 bg-panel rounded-xl',
...
export function CodeBlockTabs({ ref, ...props }: ComponentProps<typeof Tabs>) {
	...
	return (
		<Tabs
			...
			{...props}
			className={cn('bg-panels border', !nested && 'my-4', props.className)}
		>
...
export function CodeBlockTabsList(props: ComponentProps<typeof TabsList>) {
	return (
		<TabsList
			{...props}
			className={cn('flex flex-row px-2 overflow-x-auto text-ink-light', props.className)}
		>
			{props.children}
		</TabsList>
	);
